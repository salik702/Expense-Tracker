...
permission:
  ...
  bash:
    "git *": allow
    "*": deny
  mcp__github__create_pull_request: allow
  mcp__github__merge_pull_request: allow
  mcp__github__delete_branch: allow
---
...
```
Read .opencode/specs/ to find the spec for the current feature.
